...
try:
    ...
    st.error("No se encontró el archivo del modelo. Verifica que el archivo .pkl esté en la misma carpeta.")
...
if st.button("Analizar Riesgo"):
    ...
    if bmi > 40 and gen_hlth >= 4:
        res = 2   #rojo
    elif bmi > 27 or gen_hlth >= 3:
        res = 1   #amarillo
    else:
        res = prediccion   
